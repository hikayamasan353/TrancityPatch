...
namespace ODE_Test
{
	partial class ExceptionHandlerForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.Exc_Label.Text = "Unhandled exception of type {0} was thrown by {1}!";
			// 
			// Message_TextBox
			// 
			...
			this.StackTrace_Label.Size = new System.Drawing.Size(65, 13);
			this.StackTrace_Label.TabIndex = 2;
			this.StackTrace_Label.Text = "Stack trace:";
			// 
			// pictureBox1
			// 
			...
			this.ExcName_Label.Text = "Unhandled exception of type {0} was thrown by \r\n{1}!";
			// 
