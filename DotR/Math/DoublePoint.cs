...
namespace Engine
{
    ...
    /// 2D vector position.
    /// 2D векторные координаты и точки.
    /// </summary>
    ...
    public struct DoublePoint : IEquatable<DoublePoint>
    {
        ...
        /// <summary>
        /// Вычисляем точку по углу вектора относительно X, принимая начало за ноль
        /// </summary>
        ...
        /// <summary>
        /// Модуль вектора (точки) - расстояние от нуля до точки
        /// </summary>
        ...
        #region Unused DoublePoint-to-Point attachment
        ...
        #region Unused comparation operators
