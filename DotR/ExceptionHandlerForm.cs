...
namespace ODE_Test
{
	...
	public partial class ExceptionHandlerForm : Form
	{
		...
		private ExceptionHandlerForm(Exception exc, string source, string comment, bool aborted, bool terminated)
		{
			//
		...
		{
			var handler_form = new ExceptionHandlerForm(exc, "some user-code", comment, false, true);
			return handler_form.ShowDialog();
		}
	}
}
